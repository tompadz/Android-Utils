...
//from https://github.com/tompadz/Android-Utils/blob/main/Utils
...
class AndroidUtils {
    companion object {
        ...
        fun View.updateViewShow( show : Boolean) {
            updateViewShow(show, true, true)
        }

        fun View.updateViewShow(show : Boolean, scale : Boolean, animated : Boolean) {
            updateViewShow(show, scale, 0f, animated, null)
        }
        ...
        fun View.updateViewShow(
            ...
            updateViewShow(show, scale, 0f, animated, onDone)
        }
